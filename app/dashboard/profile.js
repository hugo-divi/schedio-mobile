...
export default function ProfileScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.progressBarBg}>
          <LinearGradient
            ...
            style={[
              ...
              { width: `${Math.min(100, (gamification?.xp % 1000) / 10)}%` },
            ]}
          />
        </View>
        <View style={styles.xpLabels}>
          <Text style={styles.xpProgressText}>{(gamification?.xp || 0) % 1000} / 1000 XP</Text>
          <Text style={styles.xpPercentageText}>
            {Math.floor(((gamification?.xp || 0) % 1000) / 10)}%
          </Text>
        </View>
      </GlassCard>
        ...
        <View style={styles.insightItem}>
          ...
          <View style={styles.insightContent}>
            ...
            <Text style={styles.insightText}>
              Basado en tus últimos exámenes, tu tendencia es positiva. ¡Vas por el buen camino!
            </Text>
          </View>
        </View>
        <TouchableOpacity style={styles.viewMoreBtn} onPress={() => setShowInsightsModal(true)}>
            ...
            >
              <GlassCard style={styles.subjectGlass}>
                <View
                  style={[
                    styles.subjectIcon,
                    { backgroundColor: (subject.color || '#007AFF') + '20' },
                  ]}
                >
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                  {RANKS.map((rank, index) => (
                    <View
                      ...
                      style={[
                        styles.rankItem,
                        gamification?.rank === rank.title && styles.activeRankItem,
                      ]}
                    >
                      <View
                        style={[styles.rankIconContainer, { backgroundColor: rank.color + '20' }]}
                      >
                        <Star
                          size={20}
                          color={rank.color}
                          fill={gamification?.level >= rank.minLevel ? rank.color : 'transparent'}
                        />
                      </View>
                      <View style={styles.rankInfo}>
                        <Text
                          style={[
                            styles.rankTitle,
                            { color: gamification?.level >= rank.minLevel ? '#FFFFFF' : '#48484A' },
                          ]}
                        >
                          {rank.title}
                        </Text>
                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
                  <GlassCard style={styles.detailCard}>
                    ...
                    <Text style={styles.detailBody}>
                      Has aumentado tus horas de estudio un 15% respecto a la semana pasada. La
                      constancia es clave.
                    </Text>
                  </GlassCard>
                  <GlassCard style={styles.detailCard}>
                    ...
                    <Text style={styles.detailBody}>
                      Destacas en el cumplimiento de tus micro-planes diarios. Tu tasa de éxito es
                      del 92%.
                    </Text>
                  </GlassCard>
                  <GlassCard style={styles.detailCard}>
                    ...
                    <Text style={styles.detailBody}>
                      Las sesiones nocturnas parecen ser menos productivas para ti. Prueba a
                      adelantar tus bloques de estudio.
                    </Text>
                  </GlassCard>
                </ScrollView>
              </View>
              ...
              <View style={styles.modalContent}>
                <View style={styles.modalHeader}>
                  <Text style={styles.modalTitle}>
                    {selectedSubject ? 'Gestionar Materia' : 'Nueva Materia'}
                  </Text>
                  <TouchableOpacity
                          ...
                          <View key={exam.id} style={styles.examItem}>
                            <View style={styles.examInfo}>
                              ...
                              <Text style={styles.examDate}>
                                {exam.date.toLocaleDateString('es-ES', {
                                  day: 'numeric',
                                  month: 'short',
                                })}
                              </Text>
      ...
      >
        <BlurView intensity={20} tint="dark" style={styles.deleteModalOverlay}>
              ...
              <TouchableWithoutFeedback>
                <GlassCard style={styles.deleteModalContent}>
                  ...
                  <Text style={styles.modalDescription}>
                    ...
                    ? Esta acción no se puede deshacer y perderás el progreso asociado.
                  </Text>

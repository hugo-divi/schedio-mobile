# Schedio — AGENTS.md (contexto cross-tool para agentes de código)

Este archivo lo leen agentes como Antigravity, Codex o Cursor. Contiene el mismo contexto que CLAUDE.md — mantener ambos sincronizados si se edita uno.
...
5. Auth conforme a políticas de datos de Google con Firebase Auth:
   - Verificación de email en registro (activar en Firebase Auth, es config, no código nuevo)
